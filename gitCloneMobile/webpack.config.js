...
alias = Object.assign(alias, pickFiles({
  id: /(reducers\/[^\/]+).js/,
  pattern: SRC_PATH + '/reducers/index.js'
}));
...
if (__DEV__) {
  config.module.loaders.push({
    ...
    loader: 'style!css!px2rem?remUnit=75&remPrecision=8!postcss!sass'
  });
} else {
  config.module.loaders.push({
    test: /\.(scss|css)$/,
...
config.plugins.push(
  new HtmlwebpackPlugin({
    filename: 'index.html',
    chunks: ['app', 'lib'],
    template: ROOT_PATH + '/public/app.html',
